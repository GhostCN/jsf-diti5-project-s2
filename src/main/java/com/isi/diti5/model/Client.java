...
@NamedQueries({
    ...
    , @NamedQuery(name = "Client.findByIdclient", query = "SELECT c FROM Client c WHERE c.id = :id")
...
public class Client implements Serializable {
   ...
   // @Basic(optional = false)
    ...
    public Client(Integer id, String numpiece, String prenom, String nom, String adresse, String tel, String email) {
        this.id = id;
